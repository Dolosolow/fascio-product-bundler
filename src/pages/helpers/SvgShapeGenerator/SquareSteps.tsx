export const squareStepCCM = (svgAttrs: Builder.Grup.SvgAttributes) => (
  ...
  >
    <path d="M15 14.1206H116" stroke={svgAttrs.steps_borderColor} strokeWidth="1.75886" />
    <circle
      cx="90"
      cy="16"
      r="14.5"
...
export const squareStepCNM = (svgAttrs: Builder.Grup.SvgAttributes) => (
  <svg
    ...
    style={{ paddingLeft: '8px' }}
  >
    <path d="M16 14.1206H117" stroke={svgAttrs.steps_borderColor} strokeWidth="1.75886" />
    <circle
      cx="91"
      cy="16"
      r="14.5"
