export const burstStepCCM = (svgAttrs: Builder.Grup.SvgAttributes) => (
  <svg
    width="120"
    height="100"
    viewBox="0 0 120 42"
  ...
  >
    <path d="M19 19.1206H120" stroke={svgAttrs.borderColor} strokeWidth="1.75886" />
    <circle
      cx="94"
      cy="21"
      r="14.5"
...
export const burstStepCM = (svgAttrs: Builder.Grup.SvgAttributes) => (
  <svg
    width="120"
    height="100"
    viewBox="0 0 120 42"
...
export const burstStepCNM = (svgAttrs: Builder.Grup.SvgAttributes) => (
  <svg
    width="120"
    height="100"
    viewBox="0 0 120 41"
    ...
    style={{ paddingLeft: '8px' }}
  >
    <path d="M19 18.1206H120" stroke={svgAttrs.borderColor} strokeWidth="1.75886" />
    <circle
      cx="94"
      cy="20"
      r="14.5"
...
export const burstStepNM = (svgAttrs: Builder.Grup.SvgAttributes) => (
  <svg
    width="120"
    height="100"
    viewBox="0 0 120 41"
...
const svgs: Builder.Grup.StepSvgInput[] = [
  {
    id: 'step-ccm-brst',
    generate: burstStepCCM,
  },
  {
    id: 'step-cm-brst',
    generate: burstStepCM,
  },
  {
    id: 'step-cnm-brst',
    generate: burstStepCNM,
  },
  {
    id: 'step-nm-brst',
    generate: burstStepNM,
  },
];
