export const editableStepColorCM = (steps: {
...
export const editableStepCM = (steps: {
  alternateBgColor?: string;
  bgColor?: string;
  borderColor?: string;
  fontColor?: string;
...
export const editableStepColorNM = (steps: {
  alternateBgColor?: string;
  bgColor?: string;
  borderColor?: string;
  fontColor?: string;
...
export const editableStepNM = (steps: {
  alternateBgColor?: string;
  bgColor?: string;
  borderColor?: string;
  fontColor?: string;
...
const svgs = [editableStepColorCM, editableStepCM, editableStepColorNM, editableStepNM];
